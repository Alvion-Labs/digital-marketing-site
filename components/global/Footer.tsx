    ...
    <footer className="bg-[#061c2e] border-t border-white/10 py-12">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h3 className="text-xl font-bold gradient-text mb-3">Alvion Digital Marketing</h3>
            ...
            <div className="flex items-center gap-4 mt-5">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="text-slate-400 hover:text-[#00A3FF] transition-colors duration-200"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li>
                <a href="mailto:hello@alviondigital.com" className="hover:text-white transition-colors">
                  hello@alviondigital.com
                </a>
              </li>
              <li>
